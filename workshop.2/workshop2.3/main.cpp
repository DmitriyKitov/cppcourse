...
int main()
{
    ...
    addBall(balls, sf::Color(0xFF, 0x0, 0x0), sf::Vector2f(100, 100), rnd_speed(generator));
    addBall(balls, sf::Color(0x0, 0xFF, 0x0), sf::Vector2f(200, 300), rnd_speed(generator));
    addBall(balls, sf::Color(0xFF, 0x0, 0xFF), sf::Vector2f(600, 600), rnd_speed(generator));
    addBall(balls, sf::Color(0xFF, 0xFF, 0x0), sf::Vector2f(700, 100), rnd_speed(generator));
